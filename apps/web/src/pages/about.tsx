...
import { Github, Twitter, Mail, MapPin, Heart, Code2, Coffee, Sparkles, Zap, Globe, Terminal } from 'lucide-react';
    ...
    <div className="min-h-screen pt-24 pb-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <motion.a
                    ...
                    className="w-10 h-10 rounded-lg glass flex items-center justify-center text-gray-400 hover:text-white hover:border-neon-cyan/50 transition-all"
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="font-display text-2xl font-bold text-white mb-8 text-center">博客技术栈</h2>
        ...
        >
          <div className="p-8 rounded-2xl glass">
            ...
            <h3 className="font-display text-xl font-bold text-white mb-2">感谢你的访问</h3>
            <p className="text-gray-400 mb-6">如果你对我的文章感兴趣，欢迎订阅 RSS 或通过社交媒体关注我</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/" className="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-neon-cyan to-neon-purple text-void-primary font-semibold hover:opacity-90 transition-opacity">
                浏览文章
              </Link>
              <a href="/rss" className="w-full sm:w-auto px-6 py-3 rounded-xl glass border border-white/20 text-white font-medium hover:border-neon-cyan/50 transition-colors">
                订阅 RSS
              </a>
            </div>
          </div>
