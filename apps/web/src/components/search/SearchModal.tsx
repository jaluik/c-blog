      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="border-t border-border-subtle px-3 sm:px-4 py-2 sm:py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0 text-xs text-text-tertiary">
